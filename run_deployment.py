...
@click.option(
    ...
    "('predict'), By default both pipelines will be run"
    "('deploy_and_predict').",
)
@click.option(
    "--min-accuracy",
...
def run_deployment(config: str , min_accuracy: float):
    ...
    if deploy:
        continuous_deployment_pipeline(
            data_path="/home/ayushz/ML/MLOps/Project_1/data/olist_customers_dataset.csv",
    ...
    print(
        ...
        "[/italic green]\n ...to inspect your experiment runs wihin the MLflow"
        " UI.\nYour can find your runs tracked within the"
